    ...
    <div>
      <div className="numpad-con ">
        <div className="tab-con">
          <div className="tab-right-con flex gap-2 justify-start items-center">
            <hr className="border-solid border-2 border-[#4400A5] w-[39px]" />
            <div className="num-title">กดเลข</div>
          </div>
